...
import { Trophy, MapPin, Clock, Award, Shield, Settings } from "lucide-react"
                  ...
                  <div className="flex flex-wrap justify-start gap-2">
                    <Badge variant="outline" className="bg-black text-white border-black hover:bg-gray-800 px-3 py-1">
                      <img
                        ...
                        alt="Nike"
                        className="w-4 h-4 mr-2 bg-white rounded-sm p-0.5"
                      />
                      Nike Explorer
                    </Badge>
                    <Badge variant="outline" className="bg-black text-white border-black hover:bg-gray-800 px-3 py-1">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm text-gray-600">
                {Math.round((user.stats.termines / user.stats.inscrits) * 100)}%
              </span>
            </div>
